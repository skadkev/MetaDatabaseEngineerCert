...
--Task 1**: Write a SQL SELECT query using appropriate MySQL string functions to list items, quantities and order status in the following format: Item name–quantity–order status

SELECT
CONCAT(Name,"-",Quantity,"-",OrderStatus)
FROM item, mg_orders
